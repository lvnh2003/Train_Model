...
data = pd.read_csv('./logicstic_regression/dataset.csv').values
# d là số cột (đặc trưng) trong data
N, d = data.shape 
...
for i in range(1, numOfIteration):
    ...
    # Gradient descent cập nhật w mới vector X chuyển vị nhân với giá trị pred - real
